      ...
      <div class="card mt-5">
        ...
        <div class="card-footer">
          <div class="d-flex justify-content-center links">
            ...
            <button type="button" class="mx-2 btn btn-light" @click="$router.push('register')" style="font-weight:bold;">Registrarse</button>
          </div>
        </div>
      </div>
    </div>
...
<style media="screen">
  ...
  html,
  body {
    background-image: url('https://cdn.create.vista.com/api/media/small/313383174/stock-vector-halloween-jugs-sweets-and-potions');
