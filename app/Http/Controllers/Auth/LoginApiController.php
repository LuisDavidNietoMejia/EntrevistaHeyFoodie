...
class LoginApiController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if($userModel == null) {
            return ResponseJson::danger(['danger'=>'Usuario inexistente']);
        }
    ...
    public function logout(Request $request)
    {
        ...
        try {
            ...
            return ResponseJson::danger(['danger'=> 'El token de autenticaciòn no ha sido enviado... este campo es requerido.']);
        }
